...
const checkout = async (req, res) => {
    ...
    const subtotal = req.body.cart_items.reduce((acc, it) => {
...
const paymentVerification = async (req, res) => {
    ...
    const generatedSignature = crypto.createHmac('sha256', process.env.RAZOR_PAY_API_SECRET_KEY)
        .update(body)
        .digest('hex');
...
//# sourceMappingURL=chekoutRoutes.js.map